...
Purpose: To test each function in the waterflow.py file.
"""
...
def test_pressure_gain_form_water_height():
...
def test_pressure_loss_from_height():
...
def test_pressure_loss_from_pipe_reduction():
    ...
    assert pressure_loss_from_pipe_reduction(0.28687, 1.75, 500318, 0.048692) == approx(0-184.182, abs=0.001)
