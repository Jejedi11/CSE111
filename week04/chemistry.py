...
def make_periodic_table():
    ...
    index = 0
    periodic_table_dict = {}
    periodic_table_split = []
    periodic_table = elements.splitlines()
    for line in periodic_table:
        periodic_table_split.append(line.split(","))
    
    for item in periodic_table_split:
        periodic_table_dict[item[0].strip()] = [item[1].strip(), float(item[2].strip())]
